...
.set numStreamChannels__9AudParams, 0x807DCAF8
...
.set PowerStar_LightStr_Loc, 0x806ADD0C
...
.set unk_807D57D8, 0x807DAED8
.set unk_807D2AB4, 0x807D81B4
.set BgmChangeArea_AreaMgr_Str, 0x8066F7C0
.set WaitStringJapanese, 0x807DEFCC
.set animeFunc__19MameMuimuiAttackManFUl, 0x80351F60
.set getSceneMessageDirect__2MRFPCcl, 0x80041410
.set sDisplayFramesMin__33_unnamed_InformationObserver_cpp_, 0x807D5928
.set InfoObserverCamera_StrJp, 0x806FA224
.set createZoneMsgId__2MRFPCclPCcl, 0x800416D0
.set AnimName, 0x80684378
...
.set CircleWipe_StrJp, 0x806FE7DC
...
.set __vt__11TakeOutStar, 0x806642F8
.set takeOut__11TakeOutStarFv, 0x8004A220
.set getCurrentScore__2MRFv, 0x80376FD0
.set requestStageRestart__2MRFv, 0x804D6840
.set CaretakerData, 0x806BD2D0
.set sInstance__Q212NrvCaretaker16CaretakerNrvWait, 0x807D9F2C
.set unk_807D4828, 0x807D9F28
.set unk_807D4824, 0x807D9F24
.set unk_807D4820, 0x807D9F20
.set Caretaker_Str, 0x806BD330
.set Caretaker_BodyColor_Str, 0x806BD33C
.set Caretaker_Bspinhit_Str, 0x806BD354
.set Caretaker_Bwaitstand_Str, 0x806BD36C
.set Caretaker_Btrampled_Str, 0x806BD348
.set Caretaker_Btalkhelp_Str, 0x806BD360
.set Caretaker_Bruntalk_Str, 0x806BD378
.set Caretaker_Bwaitrun_Str, 0x806BD384
.set Caretaker_Dirt_Str, 0x806BD390
.set Caretaker_Wait_Str, 0x806BD398
.set Caretaker_TakeOutStarCaretakerFreeHand_Str, 0x806BD3A0
.set Caretaker_TakeOutStarCaretaker_Str, 0x806BD3C0
.set Caretaker_SpinHit_Str, 0x806BD3D8
.set Caretaker_TalkNormal_Str, 0x806BD3F8
.set Caretaker_WaitRun_Str, 0x806BD408
.set Caretaker_Trampled_Str, 0x806BD3E0
.set Caretaker_TalkAngry_Str, 0x806BD3EC
.set Caretaker_GarbageManagement, 0x806BD410
.set Caretaker_flt_0, 0x807E4744
.set Caretaker_flt_3, 0x807E4748
.set Caretaker_flt_2, 0x807E474C
.set Caretaker_flt_0_1, 0x807E4750
.set Caretaker_flt_0_05, 0x807E4754
.set Caretaker_flt_350, 0x807E4758
.set CareTaker_BranchFuncComet, 0x806BD300
.set CareTaker_EventFuncComet, 0x806BD30C
.set CareTaker_BranchFuncStar, 0x806BD318
.set CareTaker_AnimeFunc, 0x806BD324
.set unk_807D1E78, 0x807D7578
...
.set unk_807D585C, 0x807DAF5C
.set sub_80492CB0, 0x80492CB0
.set unk_807D5834, 0x807DAF34
...
.set sInstance__29SingletonHolder_10FileLoader_, 0x807D649C
...
.set unk_807D5E10, 0x807DB510
.set sub_800614B0, 0x800614B0
.set TicoFatStarPiece_Reaction, 0x806C3D18
.set TicoFatStarPiece_Pointing, 0x806C3D24
.set TicoFatStarPiece_Trampled, 0x806C3D30
.set TicoFatStarPiece_Spin, 0x806C3D3C
.set TicoFatCamera_Jp, 0x806C3D48
.set TicoFatStarPiece_EventFunc, 0x806C3D58
.set TicoFatStarPiece_Str, 0x806C3D64
.set TicoFatStarPieceIntroDemo_Jp, 0x806C3D78
.set TicoFatStarPiece_Demo_Str, 0x806C3D98
.set TicoFat_Request000, 0x806C3DA0
.set TicoFat_StarPiece000, 0x806C3DB4
.set TicoFatStarPiece_Wait, 0x806C3DCC
.set TicoFatStarPiece_Talk, 0x806C3DD4
.set TicoFatGoodsStarPiece, 0x806C3DDC
.set TicoFatStarPiece_Small0, 0x806C3DF4
.set TicoFatStarPiece_Normal, 0x806C3DFC
.set TicoFatStarPiece_TransformJp, 0x806C40C8
.set TicoFatStarPiece_FunctorPtr, 0x806C3F68
.set TicoFatStarPieceNrvReaction, 0x807DA350
.set TicoFatStarPieceNrvPrep, 0x807DA354
.set TicoFatStarPieceNrvWait, 0x807DA358
.set TicoFatStarPieceNrvPoint, 0x807DA35C
.set TicoFatStarPieceNrvEat, 0x807DA360
.set TicoFatStarPieceNrvChem, 0x807DA364
.set TicoFatStarPieceNrvTransform, 0x807DA368
.set TicoFatStarPiece_0f, 0x807E4CD4
.set TicoFatStarPiece_220f, 0x807E4CE4
.set TicoFatStarPiece_280f, 0x807E4CE8
.set TicoFatStarPiece_012, 0x807E4D18
.set TicoFatStarPiece_089999998, 0x807E4D18
.set TicoFatStarPiece_1000, 0x807E4D20
.set TicoFatStarPiece_100, 0x807E4D24
.set TicoFatStarPiece__1, 0x807E4CDC
.set TicoFatCoin_500, 0x807E4CCC
.set TicoFatCamera_Ptr, 0x807D5650
.set TicoFat_Fly_Str, 0x807D5648
...
.set TicoFatCoin_DataStart, 0x806C3A90
.set TicoFatCoin_FlightJp, 0x806C3B10
.set TicoFatCoin_VolDownBgm, 0x806C3B3C
.set DmTicofatMorphWipeOut, 0x806C3B48
.set ScreenEffect, 0x806C3B60
.set ScreenEffectLight, 0x806C3B70
.set ScreenEffectFog, 0x806C3B88
.set DmTicofatMorphWipeIn, 0x806C3B98
.set PlanetaryAppearance_Jp, 0x806C3B28
...
.set GhostAttackGhostManager_JpName, 0x806BE2D8
.set MBGM_MINI_GAME, 0x80662ACC
.set hasMissedInScene__2MRFv, 0x804D7060
.set DreamerDeadCountArea_ManagerName, 0x80662E38
...
.set GalaxyName_FileSelect, 0x80671670
.set UseResource_SoundScenario1, 0x8067167C
.set cMuteSettingInfo__13AudBgmSetting, 0x80645F8C
.set AudMultiBgm_FloatConversion, 0x80645D98
.set AudMultiBgm_1_0, 0x807DCC68
.set AudMultiBgm_254_0, 0x807DCC70
.set AudSingleBgm_0_0, 0x807DCC6C
.set AudSingleBgm_FloatConversion, 0x80645D98
.set sub_80081CC0, 0x80081CC0
.set sub_80081280, 0x80081280
.set Str_HitPointMeter, 0x806FAD20
.set Str_HitPointMeter_Break, 0x806FADC0
.set Str_HitPointMeter_Break123, 0x806FADE0
.set Str_HitPointMeter_Damage1, 0x806FADB0
.set Str_SuddenDeathMeter_HitPointNumber, 0x806FAD30
